        ...
        <div class="panel-body">
            <table class="table table-striped table-bordered table-hover">
                ...
                {% for action in actions %}
                    ...
                    <tr>
                        <td><input type="checkbox" class="check_group" check_group_id="action_list" id="{{ check_id }}" name="action_ids[]" value="{{ action.action_id }}"{{ module_controller_actions[action.action_id] is not empty ? ' checked' : '' }} /></td>
